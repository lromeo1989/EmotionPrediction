function [xnew,fret,iter]=dfpmin(xold,n,tolx,gtol,itmax)
%DFPMIN  Simulate the routine "dfpmin" in [1], which takes,
...
%        New York, 2nd Edition, 1992
      ...
      for its=1:itmax
          iter=its;
          [pnew,fret,check]=lnsrch(xnew,n,fp,g,xi,tolx,stpmax);
          fp=fret;
